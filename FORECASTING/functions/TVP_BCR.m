function [y_t_DMA,var_DMA,log_PL_DMA]  = TVP_BCR(y_t,X,X_fore,plag)
%==========================================================================
...
RP_type = 1;                % Type of random projection (see function getRP.m)
...
tic;
fprintf('Now you are running TVP_BCR')
fprintf('\n')
fprintf('\n')
