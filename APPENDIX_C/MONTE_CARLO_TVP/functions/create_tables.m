function [T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13] = create_tables(sel_series)
...
% MSFEs
% Table 1
load('E:\Dropbox\Dropbox\Research\GAMP\Code\2017.04.30\OUTPUT\FORECASTING\recursive\FORECASTING_(_h_=_1_).mat')
...
% Table 2
load('E:\Dropbox\Dropbox\Research\GAMP\Code\2017.04.30\OUTPUT\FORECASTING\recursive\FORECASTING_(_h_=_2_).mat')
MRMSFE = squeeze(sqrt(mean(MSFE(:,:,sel_series)))./repmat(sqrt(mean(MSFE(:,9,sel_series))),1,9));  % Mean Relative MSFE (benchmark is ARp)
entries = quantile(MRMSFE([1:8],:)',[0.05 0.25 0.50 0.75 0.95]);
SBL = entries(:,1); SNS = entries(:,2); LASSO = entries(:,3); SSVS = entries(:,4); BMA = entries(:,5); BAG = entries(:,6);DFM5 = entries(:,8); OLS = entries(:,7);
Name = {'0.05', '0.25', '0.50', '0.75', '0.95'};
...
% Table 3
load('E:\Dropbox\Dropbox\Research\GAMP\Code\2017.04.30\OUTPUT\FORECASTING\recursive\FORECASTING_(_h_=_4_).mat')
MRMSFE = squeeze(sqrt(mean(MSFE(:,:,sel_series)))./repmat(sqrt(mean(MSFE(:,9,sel_series))),1,9));  % Mean Relative MSFE (benchmark is ARp)
entries = quantile(MRMSFE([1:8],:)',[0.05 0.25 0.50 0.75 0.95]);
SBL = entries(:,1); SNS = entries(:,2); LASSO = entries(:,3); SSVS = entries(:,4); BMA = entries(:,5); BAG = entries(:,6);DFM5 = entries(:,8); OLS = entries(:,7);
Name = {'0.05', '0.25', '0.50', '0.75', '0.95'};
...
% Table 4
load('E:\Dropbox\Dropbox\Research\GAMP\Code\2017.04.30\OUTPUT\FORECASTING\recursive\FORECASTING_(_h_=_8_).mat')
MRMSFE = squeeze(sqrt(mean(MSFE(:,:,sel_series)))./repmat(sqrt(mean(MSFE(:,9,sel_series))),1,9));  % Mean Relative MSFE (benchmark is ARp)
entries = quantile(MRMSFE([1:8],:)',[0.05 0.25 0.50 0.75 0.95]);
SBL = entries(:,1); SNS = entries(:,2); LASSO = entries(:,3); SSVS = entries(:,4); BMA = entries(:,5); BAG = entries(:,6);DFM5 = entries(:,8); OLS = entries(:,7);
Name = {'0.05', '0.25', '0.50', '0.75', '0.95'};
